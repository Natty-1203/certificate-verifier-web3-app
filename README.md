...
1. Set up the required environment (Docker, Docker Compose, Node.js).
2. Generate the crypto materials for the Fabric network:
   ```bash
   ./scripts/01-generate-crypto.sh
   ```
3. Start the entire network using the provided scripts:
   ```bash
